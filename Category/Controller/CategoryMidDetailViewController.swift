...
//            }, completion: nil)
        ...
        let value1 = NSValue(cgPoint: CGPoint(x: 0.8, y: 0.8))
        let value2 = NSValue(cgPoint: CGPoint(x: 1.2, y: 1.2))
        let value3 = NSValue(cgPoint: CGPoint(x: 1.0, y: 1.0))
        let values = [value1, value2, value3]
        ani.duration  = 0.3
        ani.values = values
        cell.layer.add(ani, forKey: "")
    }
